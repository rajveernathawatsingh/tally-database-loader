...
-- PostgreSQL-only additions (mirror fork custom tables)
-- sync_log, trn_purchase_order, trn_sales_order use PostgreSQL-native types
-- and are appended here so createDatabaseTables('full') creates them automatically
